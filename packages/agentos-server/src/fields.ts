...
export const FIELDS: Record<string, FieldDef> = {
  ...
  // The owner-scope filter (see query.ts) keys off group_id + owner_id.
  agent_id: {
    key: "agent_id",
    label: "Agent ID",
    type: "string",
    sqlExpr: "SpanAttributes['computeragent.agent.id']",
    nrqlAttr: "computeragent.agent.id",
    paramType: "String",
    ops: ["eq", "neq", "in", "not_in", "exists"],
  },
  group_id: {
    ...
    label: "Group",
    type: "string",
    sqlExpr: "SpanAttributes['computeragent.group.id']",
    nrqlAttr: "computeragent.group.id",
    paramType: "String",
    ops: ["eq", "neq", "in", "not_in", "exists"],
  },
  owner_id: {
    ...
    label: "Owner",
    type: "string",
    sqlExpr: "SpanAttributes['computeragent.owner.id']",
    nrqlAttr: "computeragent.owner.id",
    paramType: "String",
    ops: ["eq", "neq", "in", "not_in", "exists"],
  },
  actor_id: {
    ...
    label: "Actor",
    type: "string",
    sqlExpr: "SpanAttributes['computeragent.actor.id']",
    nrqlAttr: "computeragent.actor.id",
    paramType: "String",
    ops: ["eq", "neq", "in", "not_in", "exists"],
  },
  operation: {
